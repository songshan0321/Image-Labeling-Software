...
db = sqlite3.connect('../database/lkydata.db')
cursor = db.cursor()
...
with open('../output/csv/output_{0}.csv'.format(current_time), 'w') as csv_file:
...
with open('../output/txt/attributes_table_{0}.txt'.format(current_time), 'w') as pt_file:
